...
@info "Threads num: $(Threads.nthreads())"

# obtain information about primal mesh and construct the dual mesh
@info "Loading mesh"
primalmesh, physicalnames_dict, all_entities_struct = complete_primalmesh(raw"/simplicial_decqed/meshes/two_JJs_on_substr_in_3d_cav_pp.msh");
@info "Constructing dual mesh"
dualmesh, primalmesh = complete_dualmesh(raw"/simplicial_decqed/meshes/two_JJs_on_substr_in_3d_cav_pp.msh");
...
@info "Apply material properties to the edges"
invlambda2 = zeros(Ne);
invepsilon = ones(Ne);
